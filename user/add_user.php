					...
					<table class="table-responsive mt-5">
						...
						<tbody>
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-user-circle"></i></span></div><input type="text" name="username" title="Username should contain lowercase or letters. e.g. john12" class="form-control form-control-sm" placeholder="Enter Username" required></div></td>
							</tr>
							<tr>
