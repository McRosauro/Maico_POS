		...
		<div id="header">
			...
			<div class="text-white mt-0 ml-5">
				<table class="table-responsive-sm">
					...
					<button id="buttons" onclick="window.location.href='monitorings/monitorings.php'" class="btn btn-secondary border mr-2 ml-2"><i class='fa fa-wifi' style='color: white'></i></i> Monitorings</button>
						<tr>
			...
			<div class="header_price border p-1">
				<h5>Grand Total</h5>
				<p class="pb-0 mr-2" style="float: right; font-size: 40px;" id="totalValue">₱ 0.00</p>
			</div>
		</div>
		<div id="content" class="mr-2">
			<div id="price_column" class="m-5 table-responsive-sm table-wrapper-scroll-y my-custom-scrollbar-a">
