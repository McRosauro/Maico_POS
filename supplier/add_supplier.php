					...
					<table class="table-responsive mt-5 ">
						...
						<tbody>
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-building"></i></span></div><input type="text" name="com_name"  title="Please inpute Company Name" class="form-control-sm form-control" placeholder="Enter Company Name" required></div></td>
							</tr>
							<tr>
								<td  valign="baseline">Firstname:</td>
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="text" name="firstname"  title="Please input Name" class="form-control-sm form-control" placeholder="Enter Firstname" required></div></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" class="form-control-sm form-control" name="number" placeholder="Enter Conctact Number" required></div></td>
							</tr>
						</tbody>
					</table>
